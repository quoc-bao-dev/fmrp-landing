...
const AuthorCard = () => {
  return (
    <div className="flex flex-col xl:flex-row gap-6 py-6 px-0 xl:px-8 2xl:px-12 rounded-3xl bg-white xl:shadow-[0px_1px_2px_0px_#1212170F,0px_1px_3px_0px_#1212171A]">
      <div className="size-16 flex-shrink-0 hidden xl:block">
        <Image
      ...
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col xl:flex-row justify-between items-start gap-4 w-full">
          <div className="flex gap-4 items-center">
            <div className="size-16 flex-shrink-0 xl:hidden">
              <Image
                src="/Author/AnBui.jpg"
                alt="author"
                width={500}
        ...
        <p className="text-sm xl:text-base font-medium text-[#231F20]">
