    ...
    return (
        <div className="grid grid-cols-16 items-center justify-center lg:gap-10 gap-4 py-10 w-full h-full">
            ...
            <AnimatedReveal
                effect="fade"
                // once={false}
                className="relative 2xl:col-span-10 lg:col-span-11 col-span-16 lg:order-1 order-0 aspect-video w-full h-auto"
            >
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="absolute w-full h-full flex items-center justify-center aspect-video"
                    >
                        <Image
                            ...
                            className="size-full rounded-3xl aspect-video"
                        />
                    </motion.div>
                </AnimatePresence>
            </AnimatedReveal>
