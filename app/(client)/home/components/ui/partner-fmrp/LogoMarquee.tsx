  ...
  return (
    <div className="space-y-4 !overflow-hidden">
      <Marquee
        ...
        gradient={true}
        direction="right"
        gradientWidth={isVisibleTablet ? 100 : 200}
        className="flex w-full overflow-hidden"
      >
        {firstRowItems.map((logo, index) => (
          <div
            key={`logo-1-${index}`}
            className="lg:w-auto w-[200px] 3xl:h-[120px] lg:h-[110px] h-auto shrink-0 lg:mx-6 lg:px-0 px-6 bg-white flex items-center overflow-hidden"
          >
            <Image
              src={logo}
              alt={`logo-1-${index}`}
