...
const FeatureThird = (props: Props) => {
  ...
  return (
    <div className="flex lg:flex-row flex-col lg:items-center 3xl:gap-24 2xl:gap-20 lg:gap-16 gap-8 lg:mt-0 !mt-8 h-full">
      {isVisibleTablet && (
        <h2 className="text-title-section-feature font-extrabold text-[#25387A] text-center">
          Lệnh Sản Xuất & In Lệnh Trực Tiếp
        </h2>
      )}
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-base-default font-medium text-[#33404A] lg:max-w-[92%] max-w-full pl-[26px]">
            Không cần tìm kiếm phức tạp, mỗi lệnh sản xuất được ghim cố định
            theo từng đơn hàng. Bạn dễ dàng theo dõi trạng thái, cập nhật từng
            bước mà không bỏ sót bất kỳ công đoạn nào.
          </p>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-2">
            ...
            <p className="text-title-feature text-[#33404A] font-bold">
              In lệnh ngay trên điện thoại – giao việc nhanh, rõ ràng, không chờ
              đợi
            </p>
          </div>

          <p className="text-base-default font-medium text-[#33404A] lg:max-w-[92%] max-w-full pl-[26px]">
            Lệnh sản xuất có mã QR riêng, dễ in – dễ đọc – dễ thực hiện. Nhân
            viên nhận việc nhanh, quản lý kiểm soát tốt, hạn chế truyền đạt sai
            thông tin.
          </p>
        </div>
