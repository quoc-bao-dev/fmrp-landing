          ...
          <div className="flex items-start gap-2 lg:col-span-1 col-span-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base-default-feature font-medium text-[#33404A] max-w-full">
                Chuẩn hoá từng công đoạn, gợi ý định mức và phân bổ nguyên liệu
                tự động – càng nhiều biến thể, càng nhẹ đầu.
              </p>
          ...
          <div className="flex items-start gap-2 lg:col-span-1 col-span-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base-default-feature font-medium text-[#33404A] lg:max-w-[95%] max-w-full">
                Tự động tính toán theo BOM, liên kết trực tiếp với kho – không
                còn sợ thiếu, trùng, hoặc lệch kế hoạch.
              </p>

              <Link
                href="https://bom.so/mrp"
                target="_blank"
                className="inline-flex items-center gap-2 text-base-default-feature text-[#0375F3] underline-offset-2 underline hover:text-[#0375F3]/80 custom-transition"
              >
                <div className="font-semibold lg:max-w-[85%] max-w-full">
