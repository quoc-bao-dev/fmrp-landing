...
const FeaturePageSection = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, #FFFFFF 0%, #F0F8FF 10.1%, #F0F8FF 90.89%, #FFFFFF 100.99%)",
      }}
    >
        ...
        >
          <span className="font-extrabold text-title-section-small text-[#1A2025] capitalize space-x-2 text-center">
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(to bottom, #0375F3 0%, #036EEA 11%, #0267E1 22%, #0261D7 33%, #025ACE 44%, #0254C5 56%, #024EBC 67%, #0148B3 78%, #0142A9 89%, #013DA0 100%)",
        ...
        <div className="flex lg:flex-row flex-col lg:items-start items-center justify-center gap-2 !mt-8 mb-8">
          ...
          {isVisibleTablet && (
            <div className="flex items-center gap-2">
              ...
              <AnimatedReveal effect="fade" className="size-8" delay={2}>
                <Image
                  width={100}
                  height={100}
