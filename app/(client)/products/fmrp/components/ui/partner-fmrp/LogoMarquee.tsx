        ...
        <div className="space-y-4 !overflow-hidden">
            <Marquee speed={30} pauseOnHover gradient={true} autoFill direction='right' gradientWidth={200} className='w-fit overflow-hidden'>
                {firstRowItems.map((logo, index) => (
                    <div key={`logo-1-${index}`} className="3xl:h-[120px] h-[110px] shrink-0 mx-6 flex items-center overflow-hidden">
                        <Image
                            src={logo}
                            alt={`logo-1-${index}`}
                            width={150}
            ...
            <Marquee speed={30} pauseOnHover gradient={true} autoFill direction='left' gradientWidth={200} className='w-fit overflow-hidden'>
                {secondRowItems.map((logo, index) => (
                    <div key={`logo-2-${index}`} className="3xl:h-[120px] h-[110px] shrink-0 mx-6 flex items-center overflow-hidden">
                        <Image
                            src={logo}
                            alt={`logo-2-${index}`}
                            width={150}
            ...
            <Marquee speed={30} pauseOnHover gradient={true} autoFill direction='right' gradientWidth={200} className='w-fit overflow-hidden'>
                {thirdRowItems.map((logo, index) => (
                    <div key={`logo-3-${index}`} className="3xl:h-[120px] h-[110px] shrink-0 mx-6 flex items-center overflow-hidden">
                        <Image
                            src={logo}
                            alt={`logo-3-${index}`}
                            width={150}
