...
const FeatureFour = (props: Props) => {
  ...
  return (
    <div className="grid md:grid-cols-2 3xl:gap-24 2xl:gap-20 lg:gap-16 gap-8 lg:mt-0 !mt-8 items-center h-full">
      {isVisibleTablet && (
        <h2 className="col-span-2 text-title-section-feature font-extrabold text-[#25387A] text-center">
          Thảo Luận & Truy Xuất Lịch Sử
        </h2>
      )}
      ...
      <div className="relative w-full h-full md:col-span-1 col-span-2">
        ...
        <AnimatedReveal effect="fade" className="relative z-10 w-full h-full">
          <Image
        ...
        <div className="grid grid-cols-2 3xl:gap-10 gap-8">
          <div className="flex items-start gap-2 lg:col-span-1 col-span-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base-default-feature font-medium text-[#33404A] max-w-full">
                Gắn thẻ người phụ trách, đính kèm hình ảnh, lưu lại toàn bộ lịch
                sử trao đổi theo từng công đoạn – đảm bảo xử lý rõ ràng, minh
                bạch và đúng người, đúng việc.
              </p>

              <Link
                href="https://bom.so/mrp"
                target="_blank"
                className="inline-flex items-center justify-between gap-2 text-base-default-feature underline-offset-2 underline text-[#0375F3] max-w-full hover:text-[#0375F3]/80 custom-transition"
              >
                <div className="font-semibold lg:max-w-[85%] max-w-full">
                  Bắt đầu số hoá trao đổi – không còn sót việc, không còn nhầm
                  người.
                </div>
          ...
          <div className="flex items-start gap-2 lg:col-span-1 col-span-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base-default-feature font-medium text-[#33404A] max-w-full">
                In tem từ điện thoại, mỗi tem chứa mã QR để tra ngược thông tin
                sản xuất – từ nguyên liệu đến ai phụ trách. Hạn chế lỗi và hỗ
                trợ kiểm hàng cực nhanh.
              </p>

              <Link
                href="https://bom.so/mrp"
                target="_blank"
                className="inline-flex items-center gap-2 text-base-default-feature underline-offset-2 underline text-[#0375F3] hover:text-[#0375F3]/80 custom-transition"
              >
                <div className="font-semibold lg:max-w-[85%] max-w-full">
                  Khám phá cách FMRP giúp bạn truy vết sản xuất dễ như đọc chat
                  nhóm
                </div>
                <div className="3xl:size-6 size-5 shrink-0">
                  <PiArrowUpRight className="size-full" />
