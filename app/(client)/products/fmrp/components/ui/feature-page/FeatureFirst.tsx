    ...
    <div className="grid md:grid-cols-2 3xl:gap-24 2xl:gap-20 lg:gap-16 gap-8 lg:mt-0 !mt-8 items-center h-full">
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-2">
            ...
            <p className="text-title-feature text-[#33404A] font-bold">
              Bạn đang loay hoay quản lý sản phẩm có nhiều kích cỡ, màu sắc?
            </p>
          </div>

          <p className="text-base-default-feature font-medium text-[#33404A] lg:max-w-[92%] max-w-full lg:pl-0 pl-[26px]">
            Phân biệt dễ dàng biến thể - sử dụng chung một mã. Dễ nhập, dễ xuất,
            không nhầm lẫn giữa các phiên bản
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-base-default-feature font-medium text-[#33404A] lg:max-w-[92%] max-w-full lg:pl-0 pl-[26px]">
            Tự động theo dõi và cảnh báo khi vật tư sắp hết hạn. Đảm bảo chất
            lượng đầu ra – tránh tồn kho lỗi, giảm rủi ro ngay từ đầu.
          </p>
        </div>
        ...
        <Link
          ...
          target="_blank"
          className="inline-flex items-center gap-2 text-base-default-feature text-[#0375F3] underline-offset-2 underline hover:text-[#0375F3]/80 custom-transition lg:pl-0 pl-[26px]"
        >
