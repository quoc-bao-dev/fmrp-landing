...
const AiBomFmrpSection = (props: Props) => {
    ...
    return (
        <div className='custom-padding-section'>
            <div className='custom-container flex items-center gap-10'>
                <div className='w-full h-auto max-w-[50%] aspect-1.75/1'>
                    <Image
                        alt="ai"
                ...
                <div className='flex flex-col gap-4 w-full max-w-[50%]'>
                    <p className='space-x-2 font-extrabold max-w-[95%]'>
                        <span
                    ...
                    <p className='text-default text-[#33404A] font-medium max-w-[95%]'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='flex items-center gap-2'>
                            <SparkleIcon className='3xl:size-6 size-5 text-[#5599EC]' />
