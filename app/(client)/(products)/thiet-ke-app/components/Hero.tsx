...
const Hero = () => {
  ...
  return (
    <div className='custom-container h-full 3xl:pt-32 xl:pt-28 pt-28 flex flex-col justify-center items-center gap-6 py-12'>
      ...
      <Image src={IMAGES.blurOrangeLarge} alt="blurOrange" width={1000} height={1000} className='absolute top-0 right-[40%] translate-x-1/2 w-[60%] object-cover z-[-1] pointer-events-none' />
    </div>
  )
}
