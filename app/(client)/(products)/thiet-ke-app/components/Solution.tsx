...
const Solution = () => {
  return (
    <div className='relative'>
      <div className='custom-container flex flex-col items-center justify-center 3xl:gap-11 xl:gap-10 lg:gap-8 gap-4'>
        <div className='flex flex-col gap-10 justify-center items-center'>
          <div className='flex flex-col gap-4 justify-center items-center'>
            ...
            <p className='text-base-default text-light-900 font-semibold'>Chuyển đổi linh hoạt, thiết kế riêng cho mỗi mô hình kinh doanh.</p>
          </div>
          <div className='flex gap-9'>
            <button className='py-3 border-b border-orange-700 flex gap-4 items-center'>
              <SellIcon className='size-6 text-orange-700 flex-shrink-0' />
              <span className='text-base-default text-orange-700 font-semibold whitespace-nowrap'>Bán hàng</span>
            </button>
            <button className='py-3 border-b border-transparent flex gap-4 items-center'>
              <ServiceIcon className='size-6 text-light-700 flex-shrink-0' />
              <span className='text-base-default text-light-700 font-semibold whitespace-nowrap'>Dịch vụ</span>
            </button>
            <button className='py-3 border-b border-transparent flex gap-4 items-center'>
              <NailIcon className='size-6 text-light-700 flex-shrink-0' />
              <span className='text-base-default text-light-700 font-semibold whitespace-nowrap'>Nail & Spa</span>
            </button>
            <button className='py-3 border-b border-transparent flex gap-4 items-center'>
              <SocialIcon className='size-6 text-light-700 flex-shrink-0' />
              <span className='text-base-default text-light-700 font-semibold whitespace-nowrap'>Mạng xã hội</span>
            </button>
            <button className='py-3 border-b border-transparent flex gap-4 items-center'>
              <SystemIcon className='size-6 text-light-700 flex-shrink-0' />
