  ...
  return (
    <div className='relative'>
      <div className='custom-container-new bg-gradient-to-r from-[#B283FF]/20 to-[#74C8F3]/20 rounded-[32px]'>
        <div className='px-[72px] flex items-center justify-center gap-[72px]'>
          <Image src={IMAGES.hosting} alt='hosting' width={1000} height={1000} className='w-[40%] h-full object-cover' />
          <div className='w-[60%] h-full flex flex-col gap-6'>
            <h2 className='text-title-section-small text-light-1000 font-extrabold capitalize'>
