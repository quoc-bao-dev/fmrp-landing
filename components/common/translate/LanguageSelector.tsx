...
const LanguageSelector = ({ classNameTrigger, styleTrigger, whileHover }: LanguageProps) => {
    ...
    return (
        <div>
            ...
            >
                <SelectTrigger
                    className={`${classNameTrigger} !border-none 3xl:min-w-[100px] lg:min-w-[90px] min-w-fit lg:w-full w-fit h-full rounded-[40px] !p-0 focus:outline-none focus:ring-0 focus:ring-offset-0`}
                        ...
                        isStateClientLayout.language.selectedLanguage && (
                            <React.Fragment>
                                <motion.div
                                    ...
                                    className="w-full h-full lg:px-3 lg:py-2 px-3 py-2 flex items-center justify-between gap-1 rounded-[40px] !border-none"
                                >
